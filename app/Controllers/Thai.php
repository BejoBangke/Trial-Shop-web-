...
use App\Models\ThaiModel;
use CodeIgniter\Exceptions\PageNotFoundException;
use CodeIgniter\Validation\StrictRules\Rules;

class Thai extends BaseController
{
    ...
    {
        $this->product = new ThaiModel();
    }
    public function index()
    {
        $product = new ThaiModel();

        $data['productx'] = $product->findAll();

        echo view('thailand', $data);
    }

    public function add()
    {
        return view('thai-add');
    }
