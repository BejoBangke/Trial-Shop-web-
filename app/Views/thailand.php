...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a title="Edit" href="<?= base_url("/thai/add/") ?>" class="btn btn-primary">Tambah</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">NO</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row->alamat; ?></td>
                                <td>
                                    <a title="Edit" href="<?= base_url("/thai/edit/" . $row->id_barang); ?>" class="btn btn-success">Edit</a>
                                    <a title="Delete" href="<?= base_url("/thai/delete/" . $row->id_barang); ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin ingin menghapus data product?')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
