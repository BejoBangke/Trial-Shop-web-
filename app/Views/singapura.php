...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 mt-5">
                    <h1 class="h3">Server : Singapura</h1>
                </div>
            </div>
        </div>
    </head>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a title="Edit" href="<?= base_url("/sing/add/") ?>" class="btn btn-primary">Tambah</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">NO</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row->alamat; ?></td>
                                <td>
                                    <a title="Edit" href="<?= base_url("/sing/edit/" . $row->id_barang); ?>" class="btn btn-success">Edit</a>
                                    <a title="Delete" href="<?= base_url("/sing/delete/" . $row->id_barang); ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin ingin menghapus data product?')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
